...
- **[Media](../servers/media/overview.md)**: Movies, TV, books (ebook, physical, audio), notes, pictures, etc
- **[Hosting](../servers/hosting.md)**: Docker and web hosting
- **[Journal System](https://github.com/inquibis/tng-journal)**:  Similar to the Captain/Personal Log system in TNG.  Video journaling with SR and keyword searching
